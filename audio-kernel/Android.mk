...
$(warning add audio flag into KBUILD_OPTIONS for cs35l45 in Android.mk for AI2205...)
KBUILD_OPTIONS += ASUS_AI2205_AUDIO=y
endif

ifneq (,$(filter y,$(ASUS_FTM)))
$(warning add audio flag into KBUILD_OPTIONS for factory function in Android.mk for AI2205...)
KBUILD_OPTIONS += ASUS_FTM_AUDIO=y
endif

ifeq ($(ASUS_GKI_BUILD),y)
$(warning add audio flag into KBUILD_OPTIONS with GKI)
KBUILD_OPTIONS += ASUS_GKI_AUDIO=y
endif
...
########################### CS35L45 AMP  ################################
$(warning build audio cs35l45 in Android.mk for AI2205...)
include $(CLEAR_VARS)
LOCAL_SRC_FILES           := $(AUDIO_SRC_FILES)
