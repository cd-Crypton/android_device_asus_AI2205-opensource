...
static const char * const cs35l45_i2c_name_32h[16] = {
	"cs35l45.0-0032",
	"cs35l45.1-0032",
	"cs35l45.2-0032",
	"cs35l45.3-0032",
		...
		if (dai_link[i].num_codecs > 0) {
			for (j = 0; j < dai_link[i].num_codecs; j++) {
				...
				if (cs35l45_i2c_changed && dai_link[i].codecs[j].name != NULL) {
					if (!strncmp(dai_link[i].codecs[j].name, "cs35l45.5-0030", 64)) {
					...
					} else if (!strncmp(dai_link[i].codecs[j].name, "cs35l45.5-0031", 64)) {
						dai_link[i].codecs[j].name = cs35l45_i2c_name_31h[i2c_nr];
						printk("%s: rename dai_link[%d].codecs[%d].name = %s, dai_name = %s\n",
							__func__, i, j, dai_link[i].codecs[j].name, dai_link[i].codecs[j].dai_name);
					} else if (!strncmp(dai_link[i].codecs[j].name, "cs35l45.5-0032", 64)) {
						dai_link[i].codecs[j].name = cs35l45_i2c_name_32h[i2c_nr];
						printk("%s: rename dai_link[%d].codecs[%d].name = %s, dai_name = %s\n",
							__func__, i, j, dai_link[i].codecs[j].name, dai_link[i].codecs[j].dai_name);
					}
				}
