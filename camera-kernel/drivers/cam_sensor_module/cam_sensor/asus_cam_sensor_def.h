...
#define SENSOR_ID_OV32C4C 0x3243

#define MAX_CAMERA_ID CAMERA_4

#define EEPROM_VCM_DATA_SIZE (0x1D49 - 0x1C59 + 1)
...
#define MODULE_ID_ADDR   7213  //Mdoule ID address in share eeprom ex: OV13B10 Module ID:"0x74", addr:"7123" in EEPROM 0 (imx766)
...
#define	PROC_CSI_PHY_CHECK_COUNT	"driver/cam_csi_phy_check_count"  //ASUS_BSP "Add for camera csi debug count"


#define	PROC_VCM_DATA	"driver/camera_vcm_data"  //ASUS_BSP "Add for camera cci debug"
