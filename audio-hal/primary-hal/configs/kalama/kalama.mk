...
PRODUCT_PACKAGES += fai__2.0.0_0.1__3.0.0_0.0__3.1.2_0.0__3.2.0_0.1__eai_3.4_enpuv4.pmd
...
PRODUCT_PACKAGES += fai__2.0.0_0.1__3.0.0_0.0__eai_2.10_enpuv3.pmd
PRODUCT_PACKAGES += fai__2.9.3_0.0__3.0.0_0.0__3.1.1_0.0__3.2.0_0.1__eai_2.10_enpuv3.pmd
PRODUCT_PACKAGES += fai__2.7.5_0.0__3.0.0_0.0__eai_2.10_enpuv3.pmd
...
# ASUS_BSP for AI2205 +++
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,vendor/asus/AI2205/audio/adsp/image,$(TARGET_COPY_OUT_VENDOR)/firmware/) \
    $(call find-copy-subdir-files,*,vendor/asus/AI2205/audio/Cirrus/fw,$(TARGET_COPY_OUT_VENDOR)/firmware/)

PRODUCT_COPY_FILES += \
    $(CONFIG_PAL_SRC_DIR)/mixer_paths_AI2205.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/AI2205/mixer_paths_AI2205.xml \
    $(CONFIG_PAL_SRC_DIR)/mixer_paths_AI2205_EU.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/AI2205/mixer_paths_AI2205_EU.xml \
    $(CONFIG_PAL_SRC_DIR)/resourcemanager_AI2205.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/AI2205/resourcemanager_AI2205.xml \
    $(CONFIG_PAL_SRC_DIR)/usecaseKvManager_AI2205.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/AI2205/usecaseKvManager_AI2205.xml \
    $(CONFIG_HAL_SRC_DIR)/audio_policy_configuration_AI2205.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/AI2205/audio_policy_configuration_AI2205.xml \
    $(CONFIG_HAL_SRC_DIR)/audio_policy_volumes_AI2205.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/AI2205/audio_policy_volumes_AI2205.xml \
    $(CONFIG_HAL_SRC_DIR)/default_volume_tables_AI2205.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/AI2205/default_volume_tables_AI2205.xml \
    $(CONFIG_HAL_SRC_DIR)/audio_effects_AI2205.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/AI2205/audio_effects_AI2205.xml
...
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,vendor/asus/AI2205/audio/scripts/vendor/,$(TARGET_COPY_OUT_VENDOR)/bin/)

PRODUCT_COPY_FILES += \
    vendor/asus/AI2205/audio/AudioRoutingTest/ueventd.audio.rc:$(TARGET_COPY_OUT_VENDOR)/ueventd.audio.rc \
    vendor/asus/AI2205/audio/AudioRoutingTest/audio_gain.conf:$(TARGET_COPY_OUT_VENDOR)/etc/audio_gain.conf \
    vendor/asus/AI2205/audio/AudioRoutingTest/backend_conf.xml:$(TARGET_COPY_OUT_VENDOR)/etc/backend_conf.xml
endif
