...
enum PATTERN_PERFORM_STATE{
 ...
 extern "C" {
    ...
    extern int32_t aac_vibra_looper_prebaked_effect(uint32_t effect_id,
                     int32_t strength);
    extern int32_t aac_vibra_looper_envelope(const int32_t *envelope_data,
                          uint32_t data_len,bool fastFlag);
