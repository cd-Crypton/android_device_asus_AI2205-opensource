...
class AdapterProperties {
        ...
        try {
            ...
            if (state == BluetoothDevice.BOND_BONDED) {
                ...
                if (!mBondedDevices.contains(device)) {
                    ...
                    if(device.getName() != null && device.getName().equals(ASUS_R75_NAME)) updateR75BondState();
                }
    ...
    void updateR75BondState(){
        if (mBondedDevices.size() == 0) {
            Log.d(TAG, "No R75 headset in bonded list");
            SystemProperties.set(ASUS_R75_BONDED, "0");
            return;
        }

        boolean r75bonded = false;
        for (BluetoothDevice device : mBondedDevices) {
            if(device.getName() != null && device.getName().equals(ASUS_R75_NAME)){
                r75bonded = true;
                break;
            }
        }
        ...
        if(r75bonded){
            Log.d(TAG, "R75 headset in bonded list");
