...
class PbapStateMachine extends StateMachine {
    ...
    static final int LOAD_CONTACTS_FINISHED = 9;
        ...
        public boolean processMessage(Message message) {
            switch (message.what) {
                case REQUEST_PERMISSION:
                    ...
                    break;
                case AUTHORIZED:
                    if(BluetoothPbapService.mContactsLoaded){
                        Log.e(TAG, "Already load contacts, No need to send LOAD_CONTACTS message");
                        transitionTo(mConnected);
                        break;
                    }
                    mServiceHandler.obtainMessage(BluetoothPbapService.LOAD_CONTACTS,
