...
/*  btsnoop property
BTSNOOP_ASUS_NA      : Asus btsnoop never active, using debugger process
BTSNOOP_ASUS_STOP    : No need to log
BTSNOOP_ASUS_START   : Asus btsnoop start, start new file
BTSNOOP_ASUS_LOGGING : ASUS btsnoop start, continue logging
*/
#define BTSNOOP_ASUS_NA -1
#define BTSNOOP_ASUS_STOP 0
#define BTSNOOP_ASUS_START 1
#define BTSNOOP_ASUS_LOGGING 2
