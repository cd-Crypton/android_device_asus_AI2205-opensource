						...
						bool downgrade)
{
	...
	DP_LOG("This panel %s(0x%x), use pattern %d, downgrade %s", ctrl->panel->asus_vendor,
			ctrl->panel->asus_proc_codes, index, (downgrade ? "YES" : "NO"));
	if (dp_asus_validate_dp_version(ctrl->panel)) {
